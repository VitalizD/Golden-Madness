public static class PlayerPrefsKeys
{
    ...
    public static string MaxTileDamage { get; } = "MaxTileDamage";
    public static string HitDamageToPickaxe { get; } = "HitDamageToPickaxe";
    public static string PickaxeStrength { get; } = "PickaxeStrength";
